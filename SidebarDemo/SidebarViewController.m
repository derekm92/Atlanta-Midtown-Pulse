...
- (void)viewDidLoad
{
    ...
    _titleItems = @[@"title", @"whatshot", @"comments", @"map", @"calendar", @"wishlist", @"bookmark", @"tag"];
...
- (void) prepareForSegue: (UIStoryboardSegue *) segue sender: (id) sender
{
    ...
    destViewController.title = [[_titleItems objectAtIndex:indexPath.row] capitalizedString];
